...
namespace DefaultUrls {
  ...
  export namespace Cosmos {
    ...
    export const sei = ['https://rest-sei-test.ecostake.com/'];
    export const mars = ['https://testnet-rest.marsprotocol.io/'];
    export const juno = [
    ...
    export const likeCoin = ['https://mainnet-node.like.co/', 'https://api-likecoin-ia.cosmosia.notional.ventures/'];
    ...
    export const irisNet = ['https://api-irisnet-ia.cosmosia.notional.ventures/', 'https://lcd-iris.keplr.app/'];
